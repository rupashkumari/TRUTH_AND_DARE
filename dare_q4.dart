...
import 'package:truth/dare_q5.dart';

class DareQ4 extends StatelessWidget {
  const DareQ4 ({Key? key}) : super(key:key);
      ...
      children: [
        Container(
           ...
           height: 250,
            child: const Center(
                              child: Text(
                                '  Post the oldest selfie on\n your phone on Instagram \n               Stories.',
       ...
       const  SizedBox(
          height: 70,
            ...
            GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const DareQ5())) ,
                child: Container(
                    decoration: BoxDecoration(
