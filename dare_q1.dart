...
import 'package:truth/dare_q2.dart';

class DareQ1 extends StatelessWidget {
  const DareQ1({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
            ...
            GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const DareQ2())) ,
                child: Container(
                    decoration: BoxDecoration(
