...
import 'package:truth/nhie_q1.dart';

class NeverHaveIEver extends StatelessWidget {
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const NhieQ1())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
