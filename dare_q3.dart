...
import 'package:truth/dare_q4.dart';

class DareQ3 extends StatelessWidget {
  const DareQ3({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
            ...
            GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const DareQ4())) ,
                child: Container(
                    decoration: BoxDecoration(
