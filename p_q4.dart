...
import 'package:truth/p_q5.dart';

class PQ4 extends StatelessWidget {
  const PQ4({Key? key}) : super(key:key);
      ...
      children: [
        Container(
           ...
           height: 250,
            child: const Center(
                              child: Text(
                                ' Who is the easiest person \n   to get along with in the\n                group?',
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const PQ5())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
