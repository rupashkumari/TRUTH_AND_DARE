...
import 'package:truth/truth_q4.dart';


 class TruthQ3 extends StatelessWidget {
  const TruthQ3({super.key});
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const TruthQ4())) ,
               child:  Container(
                    decoration: BoxDecoration(
