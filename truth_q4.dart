...
import 'package:truth/truth_q5.dart';


 class TruthQ4 extends StatelessWidget {
  const TruthQ4({super.key});
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const TruthQ5())) ,
               child:  Container(
                    decoration: BoxDecoration(
