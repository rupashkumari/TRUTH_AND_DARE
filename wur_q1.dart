...
import 'package:truth/wur_q2.dart';

class WurQ1 extends StatelessWidget {
  const WurQ1({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const WurQ2())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
