...
import 'package:truth/wur_q5.dart';

class WurQ4 extends StatelessWidget {
  const WurQ4({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const WurQ5())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
