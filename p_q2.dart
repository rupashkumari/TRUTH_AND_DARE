...
import 'package:truth/p_q3.dart';

class PQ2 extends StatelessWidget {
  const PQ2({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const PQ3())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
