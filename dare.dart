...
import 'package:truth/dare_q1.dart';
      ...
      children: [
        Container(
           ...
           height: 250,
            child: const Center(
                              child: Text(
                                ' Tell the group two truths \n and a lie, and they have\n     to guess which one \n                the lie is.',
       ...
       const  SizedBox(
          ...
          GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const DareQ1())) ,
