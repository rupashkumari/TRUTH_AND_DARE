...
import 'package:truth/p_q2.dart';

class PQ1 extends StatelessWidget {
  const PQ1({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const PQ2())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
