...
import 'package:truth/dare_q3.dart';

class DareQ2 extends StatelessWidget {
  const DareQ2({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
            ...
            GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const DareQ3())) ,
                child: Container(
                    decoration: BoxDecoration(
