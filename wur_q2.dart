...
import 'package:truth/wur_q3.dart';

class WurQ2 extends StatelessWidget {
  const WurQ2({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const WurQ3())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
