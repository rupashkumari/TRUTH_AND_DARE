...
import 'package:truth/nhie_q4.dart';

class NhieQ3 extends StatelessWidget {
  const NhieQ3({Key? key}) : super(key:key);
      ...
      children: [
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const NhieQ4())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
