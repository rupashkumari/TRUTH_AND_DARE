...
import 'package:truth/wur_q1.dart';

class WouldYouRather extends StatelessWidget {
  const WouldYouRather({Key? key}) : super(key:key);
      ...
      children: [
        Container(
           ...
           height: 250,
            child: const Center(
                              child: Text(
                                ' Would you rather bounce\n off of every surface you \n touch or never be able to\n           jump again?',
