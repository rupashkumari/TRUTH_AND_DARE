...
import 'package:truth/wur_q4.dart';

class WurQ3 extends StatelessWidget {
  const WurQ3({Key? key}) : super(key:key);
      ...
      children: [
        Container(
           ...
           height: 250,
            child: const Center(
                              child: Text(
                                '     Would you rather be \n hopelessly lost in an old \n town or lost in the forest.',
       ...
       const  SizedBox(
          height: 70,
           ...
           GestureDetector(
             onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const WurQ4())) ,
                child:
                 Container(
                    decoration: BoxDecoration(
